...
#let copyright = [
  #sym.copyright Copyright KU Leuven
  #v(1em)
  ...
  #link("mailto:info@cs.kuleuven.be").
  ...
  Zonder voorafgaande schriftelijke toestemming van zowel de promotoren als de auteur
  ...
  327700 of via e-mail #link("mailto:info@cs.kuleuven.be").
