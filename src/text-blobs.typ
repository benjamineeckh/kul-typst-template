...
#let submission-text(degree, elective) = (
  "en": [
    Thesis submitted as part of the degree Master of Engineering Science: #degree, with elective #elective
  ],
  "nl" : [
...
#let copyright = (
  "en":[#sym.copyright Copyright KU Leuven
  #v(1em)
  ...
  #text(font:"DejaVu Sans Mono", size: 0.9em)[#link("mailto:info@cs.kuleuven.be")].
  ...
  327700 of via e-mail #text(font:"DejaVu Sans Mono", size: 0.9em)[#link("mailto:info@cs.kuleuven.be")].
